...
Both race and cappun are categorical variables so the analysis technique is CAT~CAT; plot is a bar plot, summary is a cross-table, inference is a chi-squared test.
