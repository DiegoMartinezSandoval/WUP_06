...
From this plot, the white race is more strongly in favor of capital punishment compared to the other races. This is due to the red bar plot being a bit higher than the blue bar numerically in 2 out of the 3 scenarios. 2/3 is .66 so it's majority of the scenarios. 
...
The p-value for black vs other race is 0.02479 so regardless, both p-values given are different. 
